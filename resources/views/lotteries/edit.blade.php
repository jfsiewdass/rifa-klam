...
<div class="row">
    <div class="col-lg-12 d-flex justify-content-between align-items-center margin-tb">
        ...
        <div class="pull-right">
            <a class="btn btn-secondary btn-sm mb-2" href="{{ route('lotteries.index') }}"><i class="fa fa-arrow-left"></i> Back</a>
        </div>
    </div>
</div>
...
<form action="{{ route('lotteries.update',$product->id) }}" method="POST">
    @csrf
    @method('PUT')
